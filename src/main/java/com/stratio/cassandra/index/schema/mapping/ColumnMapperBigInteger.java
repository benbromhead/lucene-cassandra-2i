...
/**
 * A {@link ColumnMapper} to map {@link java.math.BigInteger} values. A max number of digits must be specified.
 *
...
public class ColumnMapperBigInteger extends ColumnMapperSingle<String> {
    ...
    /**
     * Returns the {@code String} representation of the specified {@link java.math.BigInteger}.
     *
     * @param bi The {@link java.math.BigInteger} to be converted.
     * @return The {@code String} representation of the specified {@link java.math.BigInteger}.
     */
