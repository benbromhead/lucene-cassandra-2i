...
public class ColumnMapperUUID extends ColumnMapperSingle<String> {
    ...
    /**
     * Returns the {@link String} representation of the specified {@link java.util.UUID}. The returned value has the same
     * collation as {@link UUIDType}.
     *
     * @param uuid The {@link java.util.UUID} to be serialized.
     * @return The {@link String} representation of the specified {@link java.util.UUID}.
     */
