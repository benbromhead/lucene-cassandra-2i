...
public class FullKeyMapper {
    ...
    /**
     * Returns the {@link java.nio.ByteBuffer} representation of the full row key formed by the specified partition key and the
     * clustering key.
     *
     * @param partitionKey A partition key.
     * @param cellName     A clustering key.
     * @return The {@link java.nio.ByteBuffer} representation of the full row key formed by the specified key pair.
     */
