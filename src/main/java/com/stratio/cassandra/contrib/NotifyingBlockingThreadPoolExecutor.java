...
public class NotifyingBlockingThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    private class Synchronizer {
         ...
         *
         * @throws InterruptedException when the internal condition throws it.
         * @see NotifyingBlockingThreadPoolExecutor#await(long, java.util.concurrent.TimeUnit) for details.
         */
        public boolean await(long timeout, TimeUnit timeUnit) throws InterruptedException {
    ...
    private static class BlockThenRunPolicy implements RejectedExecutionHandler {
         ...
         *
         * @see java.util.concurrent.RejectedExecutionHandler#rejectedExecution(Runnable, java.util.concurrent.ThreadPoolExecutor)
         */
        @Override
