...
public class ComparatorChain<T> implements Comparator<T>, Serializable {
     ...
     * @see #ComparatorChain(java.util.List, java.util.BitSet)
     */
    ...
    /**
     * Returns <code>true</code> iff <i>that</i> Object is is a {@link java.util.Comparator} whose ordering is known to be
     * equivalent to mine.
     * <p/>
     ...
     * to override this behavior to remain consistent with the {@link java.util.Comparator#equals(Object)} contract.
     *
